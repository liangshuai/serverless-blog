...
exports.handler = (event, context, callback) => {
  ...
  return _faunadb__WEBPACK_IMPORTED_MODULE_0__["default"].query(_faunadb__WEBPACK_IMPORTED_MODULE_0__["q"].Create(_faunadb__WEBPACK_IMPORTED_MODULE_0__["q"].Collection('posts'), post)).then(ret => {
