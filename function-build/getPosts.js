...
/******/ 	return __webpack_require__(__webpack_require__.s = "./getPosts.js");
/******/ })
/************************************************************************/
/******/ ({
...
exports.handler = (event, context, callback) => {
  return _faunadb__WEBPACK_IMPORTED_MODULE_0__["default"].query(_faunadb__WEBPACK_IMPORTED_MODULE_0__["q"].Paginate(_faunadb__WEBPACK_IMPORTED_MODULE_0__["q"].Match(_faunadb__WEBPACK_IMPORTED_MODULE_0__["q"].Ref("indexes/all_posts")))).then(ret => {
    const postRefs = ret.data;
    const getAllPostDataQuery = postRefs.map(ref => {
      return _faunadb__WEBPACK_IMPORTED_MODULE_0__["q"].Get(ref);
    });
    return _faunadb__WEBPACK_IMPORTED_MODULE_0__["default"].query(getAllPostDataQuery).then(refs => {
